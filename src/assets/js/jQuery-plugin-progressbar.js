(function ($) {
  $.fn.loading = function () {
    ...
    $(this).each(function () {
      ...
      $target.append(
        '<div class="background"></div><div class="rotate"></div><div class="left"></div><div class="right"></div><div class=""><span><b>' +
          opts.percent +
          "%</b></span></div>"
      );
      ...
      if (opts.percent > 50) {
        ...
        $target.find(".right").css({ animation: animationRight, opacity: 1 });
        $target.find(".left").css({ animation: animationLeft, opacity: 0 });
      }
    });
  };
})(jQuery);
